            ...
            <div id="inscription">
                ...
                <form action="inscription.php" method="POST">
                    <fieldset id="ch1" >
                        ...
                        <input required type="tel" id="tel" name="tel" placeholder="Entre votre numero de telephone" onkeypress="return event.charCode >= 48 && event.charCode <= 57">
                        ...
                        <div class="erreur" id="erCo">Mot de passe différent</div>
                    </fieldset>
